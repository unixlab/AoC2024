...
func TestRunPart1Example(t *testing.T) {
	expectedResult := 161
	actualResult := RunPart1(aocinput.Read("../../", "day03p1", true))
...
func TestRunPart1(t *testing.T) {
	...
	actualResult := RunPart1(aocinput.Read("../../", "day03", false))
	if actualResult != expectedResult {
		t.Fatalf("RunPart1() = expected %v, got %v", expectedResult, actualResult)
	}
}
...
func TestRunPart2Example(t *testing.T) {
	expectedResult := 48
	actualResult := RunPart2(aocinput.Read("../../", "day03p2", true))
	if actualResult != expectedResult {
...
func TestRunPart2(t *testing.T) {
	...
	actualResult := RunPart2(aocinput.Read("../../", "day03", false))
	if actualResult != expectedResult {
		t.Fatalf("RunPart2() = expected %v, got %v", expectedResult, actualResult)
	}
}
